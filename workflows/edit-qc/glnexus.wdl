...
task glnexus {
  meta {
    description: "Merge gVCFs from multiple samples and joint call genotypes with GLnexus (keep max DP)"
  }
  ...
  command <<<
    ...
    genotyper_config:
      ...
      liftover_fields:
        ...
        - orig_names: [MIN_DP, DP]
          name: MIN_DP
          description: '##FORMAT=<ID=MIN_DP,Number=1,Type=Integer,Description="Minimum DP observed within the GVCF block.">'
          type: int
          combi_method: min
          number: basic
          count: 1
